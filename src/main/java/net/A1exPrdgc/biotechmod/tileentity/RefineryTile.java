...
public class RefineryTile extends TileEntity implements ITickableTileEntity, INamedContainerProvider, IFluidMachinery
{
	//-----------Constants--------------
	...
	private FluidTank createTank()
	{
		return new FluidTank(CAPACITY) {
			...
			public int fill(FluidStack resource, FluidAction action){
				...
				{
					RefineryTile.this.onTankChanged();
				}
				return filled;
			}
	...
	public Container createMenu(int i, PlayerInventory playerInventory, PlayerEntity playerEntity){
		return new RefineryContainer(i, this.world, this.pos, playerInventory, playerEntity);
	}
